        ...
        <div class='row'>
            ...
            <div class="col-sm-6">
                ...
                <table class="table table-bordered">
                    <center><h2>Edit the following deal:</h2><h3><?php echo $title ?></h3><p> <?php echo $description ?></p></center>
              ...
              //      $new_stock = htmlentities($_POST['stock']);
                   
                    

                      $update ="update deals set status='$new_status' where deal_id='$get_id'";
             //       $update ="update deals set status='$new_status', stock='$new_stock' where deal_id='$get_id'";
                ...
                if(isset($_POST['delete'])){
                    ...
                    $delete ="delete from deals where deal_id='$get_id'";
