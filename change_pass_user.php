  ...
  if (y.type === "password") {
   ...
   <table class="table table-bordered">
                  ...
                  <tr>
                   ...
                   <td>
                       <input class="form-control" type="password" name="u_pass" id="pass" required="required"> 
                  ...
                  <tr>
                   ...
                   <td>
                       <input class="form-control" type="password" name="u_pass_confirm" id="pass_confirm" required="required"> 
...
if(isset($_POST['updatePass'])){
    ...
    $u_pass_confirm = htmlentities(mysqli_real_escape_string($con,$_POST['u_pass_confirm']));
    ...
    if(strlen($a_pass) <4 ){
        ...
        $update ="update users set u_pass='".md5($u_pass)."' where user_id='$user_id'";
    ...
    if($run){
        ...
        echo"<script>window.open(change_pass_user.php?user_id=$user_id' , '_self')</script>";
    }
}
?>