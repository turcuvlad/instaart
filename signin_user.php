...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to your user account</strong></h3>
			</div>
			<div class="l-part">
				<form action="" method="post">
					<input type="email" name="u_email" placeholder="Email" required="required" class="form-control input-md"><br>
					<div class="overlap-text">
						<input type="password" name="u_pass" placeholder="Password" required="required" class="form-control input-md"><br>
					</div>
					

					<center><button id="signin" class="btn btn-info btn-lg" name="login">Login</button></center>
					<center><a style="text-decoration: none;color: #AB850D;" data-toggle="tooltip" title="Create Account!" href="signup_user.php">Don't have an account?</a><br><br></center>
